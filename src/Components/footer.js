...
const Footer = () => {
  return (
    <footer className="fixed w-full flex-col bottom-0 flex items-center justify-between drop-shadow-2xl border-b px-6 py-4 bg-white dark:bg-gray-800 sm:flex-row">
      <a
        href="/"
      ...
      <p className="py-2 text-gray-800 dark:text-white sm:py-0">
        &copy; 2022 Erlangga Juni Saputra
      </p>
